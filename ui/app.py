...
DYNAMIC_SCENARIOS: List[Dict[str, Any]] = [
    ...
    },
    {
        "id": "ID-DV-006",
        "pillar": "Identity",
        "use_case": "Risk-Based Access",
        "name": "Sign-in Risk Conditional Access Validation",
        "status": "SUPPORTED",
        "priority": "High",
        "requires": ["Entra ID P2 / Conditional Access"],
        ...
        "decoys": "Temporary standard decoy user; tester triggers risky sign-in behavior (TOR/VPN/unusual location and/or repeated wrong passwords).",
        "test_action": "Start the evidence window, perform the risky sign-in test as the decoy, then collect Entra sign-in risk and Conditional Access evidence.",
