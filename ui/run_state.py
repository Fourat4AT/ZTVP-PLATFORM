...
SCENARIO_ROUTE_MAP = {
    ...
    "APP-DV-001": {"pillar": "Applications", "scope": "Cloud", "scenario_id": "APP-DV-001"},
...
def scenario_nav_key(scenario_id: str) -> str:
    ...
    names = {
        ...
        "APP-DV-001": "Enterprise App Assignment Enforcement Probe",
        ...
        "ID-DV-006": "Sign-in Risk Conditional Access Validation",
